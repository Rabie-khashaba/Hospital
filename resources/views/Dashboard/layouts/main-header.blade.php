							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu dropdown-notifications">
									<div class="menu-header-content bg-primary text-right">
										...
										<p data-count="{{App\Models\Notification::countNotification(auth()->user()->name)}}" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 notif-count">{{App\Models\Notification::countNotification(auth()->user()->name)}}</p>
									</div>
...
{{--                                        show notification in DB--}}
                                        @foreach(App\Models\Notification::where('user_id',auth()->user()->id)->where('reader_status',0)->get() as $notifications)
                                            <a class="d-flex p-3 border-bottom" href="#">
                                                <div class="notifyimg bg-pink">
                                                    <i class="la la-file-alt text-white"></i>
                                                </div>
...
<script  type="module">
    ...
    // var pusher = new Pusher('d3a5b985766b27eb5fbc', {
    //     cluster: 'mt1'
    // });
