			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('invoices.index') }}">قائمه الكشوفات</a></li>
							<li><a class="slide-item" href="{{ route('completedInvoices') }}">قائمه الكشوفات المكتمله</a></li>
							<li><a class="slide-item" href="{{ route('reviewInvoices') }}">قائمه المرجعات</a></li>
						</ul>
					</li>
